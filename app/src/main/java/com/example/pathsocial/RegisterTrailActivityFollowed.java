...
public class RegisterTrailActivityFollowed extends AppCompatActivity implements
...
//        double lon2 = EndP.longitude;
        ...
        AlertDialog myQuittingDialogBox = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        Intent intent = new Intent(RegisterTrailActivityFollowed.this, MapPage.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(RegisterTrailActivityFollowed.this, MyTrailActivities.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        RegisterTrailActivityFollowed.this.mapboxMap = mapboxMap;
